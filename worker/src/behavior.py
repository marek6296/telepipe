...
FIELD_LABELS = {
    "mode": "režim",
    "active_tz": "časová zóna",
    "active_start_min": "aktívna od",
    "active_end_min": "aktívna do",
    "debounce_min_s": "debounce min (s)",
    "debounce_max_s": "debounce max (s)",
    "read_delay_min_s": "kým prečíta min (s)",
    "read_delay_max_s": "kým prečíta max (s)",
    "reply_delay_min_s": "kým odpíše min (s)",
    "reply_delay_max_s": "kým odpíše max (s)",
    "seen_only_chance": "šanca len „videné“",
    "seen_only_min_s": "len videné, potom min (s)",
    "seen_only_max_s": "len videné, potom max (s)",
    "long_pause_chance": "šanca dlhej pauzy",
    "long_pause_min_s": "dlhá pauza min (s)",
    "long_pause_max_s": "dlhá pauza max (s)",
    "defer_reply_chance": "šanca odloženia na hodiny",
    "defer_min_s": "odloženie min (s)",
    "defer_max_s": "odloženie max (s)",
    "greeting_gap_hours": "pozdraví po (h)",
    "no_diacritics": "bez diakritiky",
    "slang": "slang",
    "quick_reply_chance": "šanca rýchlej odpovede",
    "quick_read_max_s": "rýchle: videné do (s)",
    "quick_reply_min_s": "rýchle: odpoveď min (s)",
    "quick_reply_max_s": "rýchle: odpoveď max (s)",
    "question_chance": "šanca že sa spýta",
    "gag_chance": "šanca drzého vtipu",
    "photo_cooldown_min": "odstup medzi fotkami (min)",
    "summary_every": "zhrnutie každých N správ",
    "max_replies_per_hour": "max odpovedí/h",
    "max_links_per_hour": "max odkazov/h",
    "max_outreach_per_hour": "max oslovených sama/h",
    "max_active_chats": "rozhovorov naraz",
    "chat_slot_min": "miesto sa uvoľní po (min)",
    "activity_waves": "vlny aktivity",
    "voices_enabled": "hlasovky",
    ...
    "voice_when_doubted": "hlas keď neverí",
    "voice_when_he_voices": "hlas keď píše hlasovky",
...
_NON_NUMERIC = (
    ...
    "voices_enabled", "morning_enabled", "voice_ambience", "voice_strength",
